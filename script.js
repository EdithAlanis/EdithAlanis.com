...
const team = [
  ['Elsy Susana Edith Baltazar Alaniz',['Cofundadora · Coinventora']],
  ['Daniel Alejandro Baltazar Alaniz',['Cofundador · Coinventor']],
  ['Lisbeth Andalón Álvarez',['Asesoría Experta']],
  ['Apolonio Navarro Paredes',['Desarrollo Tecnológico']],
  ['Lorenzo Baltazar Montes',['Desarrollo Tecnológico']],
  ['Rocío Calderón García',['Vinculación Experta']],
  ['Lucio Guzmán Mares',['Vinculación Experta']],
  ['Carlos Vázquez Cid de León',['Vinculación Nacional']],
  ['Ma. Soledad Castellanos Villarruel',['Vinculación y Ortografía']],
  ['Adán Yáñez Larios',['Vinculación Internacional']],
  ['Sergio Roberto Dávalos García',['Innovación Tecnológica']],
  ['Martha Alicia González Palacios',['Coordinación Académica']]
];
